  ...
  return <main className="odShell mmShell">
    <aside className="odSidebar">
      ...
      <nav className="odNav"><span className="odNavLabel">WORKSPACE</span>
        ...
        {hasPaidAccess&&active?<Link href={`/journey/${active.id}`}><Icon name="modules"/><span>Business Journey</span><small>LIVE</small></Link>:<a className="locked" aria-disabled="true"><Icon name="modules"/><span>Business Journey</span><small>LOCKED</small></a>}
        {hasPaidAccess?<Link href="/vault"><Icon name="modules"/><span>Business Vault</span><small>NEW</small></Link>:<a className="locked" aria-disabled="true"><Icon name="modules"/><span>Business Vault</span><small>LOCKED</small></a>}
